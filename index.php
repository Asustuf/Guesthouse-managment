...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@MYGUEST.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 6364682565</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">MY <span>GUEST</span><p class="logo_w3l_agile_caption">Your GUEST HOUSE</p></a></h1>
				</div>
							...
							<div class="container">
								...
								<h4>MY GUEST</h4>
									<h3>We know what you love</h3>
										<p>Welcome to our GUEST HOUSE</p>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">MY GUEST</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About MY GUEST</h3> 
...
<!-- //gallery -->
  ...
  <!-- visitors -->
			...
			<div class="copy">
		        <p>© 2022 MY GUEST . All Rights Reserved | Design by <a href="index.php">MY GUEST</a> </p>
		    </div>
<!--/footer -->
